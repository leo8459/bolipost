...
class AclPermissionRegistry
{
    ...
    private const FEATURE_ACTION_LABELS = [
        ...
        'reprintcn33' => 'Botones de reimpresion CN-33',
    ...
    private const WINDOW_FEATURE_ALLOWLIST = [
        ...
        'paquetes-ems.encargado' => ['cancel', 'returnorigin', 'returndestination', 'returnwindow', 'updateweight', 'changecartero', 'removecartero', 'print'],
        ...
        'paquetes-ems.en-transito' => ['edit', 'print', 'reprintcn33'],
    ...
    private const LIVEWIRE_METHOD_TARGET_OVERRIDES = [
        ...
        'PaquetesEms' => [
            ...
            'reimprimircn33detalle' => [['module' => 'paquetes-ems.en-transito', 'action' => 'reprintcn33']],
        ...
        'Malencaminados' => [
            'guardarmalencaminado' => [['module' => 'malencaminados', 'action' => 'create']],
            'openeditmodal' => [['module' => 'malencaminados', 'action' => 'edit']],
            'updaterecord' => [['module' => 'malencaminados', 'action' => 'edit']],
            'delete' => [['module' => 'malencaminados', 'action' => 'delete']],
        ],
        'Saca' => [
    ...
    private const ROUTE_ACCESS_PERMISSION_OVERRIDES = [
        ...
        'bitacoras.create' => [
            'bitacoras.create',
            'feature.bitacoras.index.create',
            'feature.bitacoras.create.create',
        ],
        'bitacoras.store' => [
            'bitacoras.store',
            'feature.bitacoras.index.save',
        ...
        'bitacoras.export-excel' => [
            'bitacoras.export-excel',
            'bitacoras.index',
            'feature.bitacoras.index.export',
        ],
        'bitacoras.export-pdf' => [
            'bitacoras.export-pdf',
            'bitacoras.index',
            'feature.bitacoras.index.export',
        ],
        'bitacoras.cn33-summary' => [
            'bitacoras.cn33-summary',
            'feature.bitacoras.index.create',
            'feature.bitacoras.index.save',
            'feature.bitacoras.create.create',
        ...
        'bitacoras.extract-factura-qr-text' => [
            'bitacoras.extract-factura-qr-text',
            'feature.bitacoras.index.create',
            'feature.bitacoras.index.save',
            'feature.bitacoras.create.create',
        ...
        'paquetes-ems.entregados.no-registrado.create' => [
            'paquetes-ems.entregados.no-registrado.create',
        ...
        'paquetes-ems.entregados.no-registrado.store' => [
            'paquetes-ems.entregados.no-registrado.store',
            'feature.paquetes-ems.entregados.deliver',
            'feature.paquetes-ems.almacen.registercontract',
            'feature.paquetes-ems.contrato-rapido.create.save',
        ...
        'paquetes-ems.encargado.cambiar-cartero' => [
            'paquetes-ems.encargado.cambiar-cartero',
            'paquetes-ems.encargado',
            'feature.paquetes-ems.encargado.changecartero',
            'feature.carteros.asignados.change',
        ],
        'paquetes-ems.encargado.quitar-cartero' => [
            'paquetes-ems.encargado.quitar-cartero',
            'paquetes-ems.encargado',
    ...
    private const EXPORT_ROUTE_WINDOW_MODULES = [
        ...
        'dashboard.generacion-cn.pdf' => 'dashboard.generacion-cn',
        'dashboard.marbetes.pdf' => 'dashboard.marbetes',
        ...
        'dashboard.financiera.ventas-servicios.pdf' => 'dashboard.financiera.ventas-servicios',
        ...
        'ventas-sucursal.export.pdf' => 'mis-ventas.index',
    ...
    private static function actionLabel(string $permissionName, string $actionKey): string
    {
        $specialLabels = [
            ...
            'feature.malencaminados.create' => 'Boton: Guardar malencaminado',
            'feature.malencaminados.edit' => 'Boton: Editar observacion',
            'feature.malencaminados.delete' => 'Boton: Eliminar registro',
            ...
            'alertas-empresa.approve' => 'Accion: Corregir, aprobar y publicar alerta',
            ...
            'feature.alertas-empresa.approve' => 'Boton: Corregir y aprobar publicación',
            'feature.alertas-empresa.readers' => 'Boton: Ver usuarios que marcaron visto',
            ...
            'dashboard.global-ingreso' => 'Ventana: Global Nivel Nacional (Ingreso)',
            'dashboard.global-ingreso.excel' => 'Exportar Excel: Global Nivel Nacional (Ingreso)',
            'dashboard.global-ingreso.pdf' => 'Exportar PDF: Global Nivel Nacional (Ingreso)',
            'dashboard.global-por-servicio' => 'Ventana: Global por servicio',
            'dashboard.global-por-servicio.excel' => 'Exportar Excel: Global por servicio',
            'dashboard.global-por-servicio.pdf' => 'Exportar PDF: Global por servicio',
            'dashboard.envios-oficiales' => 'Ventana: Envios Oficiales',
            'dashboard.reimprimir-cn33' => 'Ventana: Reimprimir CN-33',
            'dashboard.reimprimir-cn33.pdf' => 'Exportar PDF: Reimprimir CN-33',
            'dashboard.reimprimir-cn33.despacho-excel' => 'Exportar Excel despacho: Reimprimir CN-33',
            'dashboard.reimprimir-cn33.excel' => 'Exportar Excel contrato: Reimprimir CN-33',
            'dashboard.generacion-cn' => 'Ventana: Generacion de CN',
            'dashboard.generacion-cn.pdf' => 'Generar PDF: Hoja de ruta CN',
            'dashboard.marbetes' => 'Ventana: Marbetes CN 35',
            'dashboard.marbetes.pdf' => 'Generar PDF: Marbete CN 35',
            'dashboard.comercial.rendimiento-servicios' => 'Ventana: Rendimiento Servicios',
            'dashboard.comercial.rendimiento-servicios.excel' => 'Exportar Excel: Rendimiento Servicios',
            'dashboard.comercial.rendimiento-servicios.pdf' => 'Exportar PDF: Rendimiento Servicios',
            'dashboard.financiera.panel' => 'Menu: Panel Financiero',
            'dashboard.financiera.presupuesto' => 'Menu: Presupuesto Institucional',
            'dashboard.financiera.ingresos-egresos' => 'Menu: Ingresos y Egresos',
            'dashboard.financiera.cuentas-cobrar' => 'Menu: Cuentas por Cobrar',
            'dashboard.financiera.indicadores' => 'Menu: Indicadores Financieros',
            ...
            'feature.paquetes-ems.almacen.weightiktoker' => 'Boton: Asignar peso a Delivery Express',
            ...
            'feature.paquetes-ems.encargado.cancel' => 'Boton: Envio cancelado',
            'feature.paquetes-ems.encargado.returnorigin' => 'Boton: Devuelto a almacen origen',
            'feature.paquetes-ems.encargado.returndestination' => 'Boton: Devuelto a almacen destino',
            'feature.paquetes-ems.encargado.returnwindow' => 'Boton: Devuelto a ventanilla',
            'feature.paquetes-ems.encargado.updateweight' => 'Boton: Guardar peso',
            'feature.paquetes-ems.encargado.changecartero' => 'Boton: Cambiar cartero',
            'feature.paquetes-ems.encargado.removecartero' => 'Boton: Quitar cartero',
            'feature.paquetes-ems.encargado.print' => 'Boton: Reimprimir',
            ...
            'feature.paquetes-ems.en-transito.reprintcn33' => 'Boton: Reimprimir CN-33',
            'feature.paquetes-ems.entregados.deliver' => 'Boton: Entregar envio no registrado',
            'feature.paquetes-ems.entregados.print' => 'Boton: Reimprimir boleta',
            ...
            'feature.bitacoras.index.edit' => 'Boton: Editar',
            'feature.bitacoras.index.delete' => 'Boton: Eliminar',
            'feature.bitacoras.index.export' => 'Boton: Exportar reporte',
            'feature.bitacoras.create.create' => 'Boton: Abrir formulario nuevo',
            'feature.bitacoras.create.save' => 'Boton: Guardar bitacora',
            ...
            'feature.eventos-tiktoker.index.create' => 'Boton: Nuevo registro Delivery Express',
            'feature.eventos-tiktoker.index.edit' => 'Boton: Editar registro Delivery Express',
            'feature.eventos-tiktoker.index.delete' => 'Boton: Eliminar registro Delivery Express',
    ...
    private static function permissionHint(string $permissionName, string $moduleKey, string $actionKey): ?string
    {
        $specialHints = [
            ...
            'feature.malencaminados.create' => 'Controla el boton Guardar Malencaminado dentro de la ventana Malencaminados.',
            'feature.malencaminados.edit' => 'Controla el boton Editar y Guardar cambios de observacion dentro de la ventana Malencaminados.',
            'feature.malencaminados.delete' => 'Controla el boton Eliminar dentro del historial de la ventana Malencaminados.',
            ...
            'alertas-empresa.approve' => 'Permite corregir y aprobar una alerta pendiente antes de publicarla.',
            ...
            'feature.alertas-empresa.approve' => 'Controla el boton y el modal para corregir, aprobar y publicar una alerta pendiente.',
            'feature.alertas-empresa.readers' => 'Controla el boton y el modal con los usuarios que marcaron una alerta como vista.',
            ...
            'dashboard.financiera.flujo-cajero' => 'Controla el acceso al reporte de ventas por departamento y cajero de Dir. Financiera.',
            ...
            'dashboard.global-ingreso' => 'Controla el acceso a la ventana Global Nivel Nacional (Ingreso).',
            'dashboard.global-ingreso.excel' => 'Controla la exportacion Excel de la ventana Global Nivel Nacional (Ingreso).',
            'dashboard.global-ingreso.pdf' => 'Controla la exportacion PDF de la ventana Global Nivel Nacional (Ingreso).',
            'dashboard.global-por-servicio' => 'Controla el acceso a la ventana Global por servicio.',
            'dashboard.global-por-servicio.excel' => 'Controla la exportacion Excel de la ventana Global por servicio.',
            'dashboard.global-por-servicio.pdf' => 'Controla la exportacion PDF de la ventana Global por servicio.',
            'dashboard.envios-oficiales' => 'Controla el acceso a la ventana Envios Oficiales dentro del menu Dir. Operaciones.',
            'dashboard.reimprimir-cn33' => 'Controla el acceso a la ventana Reimprimir CN-33.',
            'dashboard.reimprimir-cn33.pdf' => 'Controla la exportacion PDF desde Reimprimir CN-33.',
            'dashboard.reimprimir-cn33.despacho-excel' => 'Controla la exportacion Excel de despachos desde Reimprimir CN-33.',
            'dashboard.reimprimir-cn33.excel' => 'Controla la exportacion Excel por contrato desde Reimprimir CN-33.',
            'dashboard.generacion-cn' => 'Controla el acceso a la ventana Generacion de CN.',
            'dashboard.generacion-cn.pdf' => 'Controla la generacion de la hoja de ruta CN en PDF.',
            'dashboard.marbetes' => 'Controla el acceso a la ventana de marbetes CN 35.',
            'dashboard.marbetes.pdf' => 'Controla la generacion de marbetes CN 35 en PDF.',
            'dashboard.comercial.rendimiento-servicios' => 'Controla el acceso a la ventana Rendimiento Servicios de Dir. Comercial.',
            'dashboard.comercial.rendimiento-servicios.excel' => 'Controla la exportacion Excel de Rendimiento Servicios.',
            'dashboard.comercial.rendimiento-servicios.pdf' => 'Controla la exportacion PDF de Rendimiento Servicios.',
            'dashboard.financiera.panel' => 'Controla la visibilidad del acceso Panel Financiero.',
            'dashboard.financiera.presupuesto' => 'Controla la visibilidad del acceso Presupuesto Institucional.',
            'dashboard.financiera.ingresos-egresos' => 'Controla la visibilidad del acceso Ingresos y Egresos.',
            'dashboard.financiera.cuentas-cobrar' => 'Controla la visibilidad del acceso Cuentas por Cobrar.',
            'dashboard.financiera.indicadores' => 'Controla la visibilidad del acceso Indicadores Financieros.',
            ...
            'feature.paquetes-ems.almacen.weightiktoker' => 'Controla el boton Asignar peso a Delivery Express y su modal dentro de la ventana Almacen EMS.',
            ...
            'feature.paquetes-ems.encargado.cancel' => 'Controla el boton Envio cancelado dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.returnorigin' => 'Controla el boton Devuelto a almacen origen dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.returndestination' => 'Controla el boton Devuelto a almacen destino dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.returnwindow' => 'Controla el boton Devuelto a ventanilla dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.updateweight' => 'Controla el cambio de peso y el boton Guardar dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.changecartero' => 'Controla el boton Cambiar cartero dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.removecartero' => 'Controla el boton Quitar cartero dentro de la ventana Encargado EMS.',
            'feature.paquetes-ems.encargado.print' => 'Controla el boton Reimprimir dentro de la ventana Encargado EMS.',
            ...
            'feature.paquetes-ems.en-transito.reprintcn33' => 'Controla el boton Reimprimir CN-33 del detalle de codigo especial dentro de la ventana En transito.',
            'feature.paquetes-ems.entregados.deliver' => 'Controla Entregar envio no registrado dentro de la ventana EMS entregados.',
            'feature.paquetes-ems.entregados.print' => 'Controla Reimprimir boleta dentro de la ventana EMS entregados.',
            ...
            'feature.eventos-tiktoker.index.create' => 'Controla el boton Nuevo y Crear dentro de la ventana Eventos Delivery Express.',
            'feature.eventos-tiktoker.index.edit' => 'Controla el boton Editar y Guardar cambios dentro de la ventana Eventos Delivery Express.',
            'feature.eventos-tiktoker.index.delete' => 'Controla el boton Eliminar dentro de la ventana Eventos Delivery Express.',
