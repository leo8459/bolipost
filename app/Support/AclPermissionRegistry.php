...
class AclPermissionRegistry
{
    ...
    private const WINDOW_FEATURE_ALLOWLIST = [
        ...
        'paquetes-ems.almacen' => ['create', 'edit', 'print', 'assign', 'restore'],
    ...
    private const LIVEWIRE_METHOD_TARGET_OVERRIDES = [
        ...
        'PaquetesEms' => [
            ...
            'openregionalmodal' => [['module' => 'paquetes-ems.almacen', 'action' => 'assign']],
            'openregionalcontratomodal' => [['module' => 'paquetes-ems.almacen', 'action' => 'assign']],
            'opencontratoregistrarmodal' => [['module' => 'paquetes-ems.almacen', 'action' => 'create']],
            'registrarcontratorapido' => [['module' => 'paquetes-ems.almacen', 'action' => 'create']],
            'opencontratopesomodal' => [['module' => 'paquetes-ems.almacen', 'action' => 'edit']],
            'buscarcontratoparapeso' => [['module' => 'paquetes-ems.almacen', 'action' => 'edit']],
            'guardarpesocontratoporcodigo' => [['module' => 'paquetes-ems.almacen', 'action' => 'edit']],
            'togglecn33reprint' => [['module' => 'paquetes-ems.almacen', 'action' => 'print']],
            'reimprimircn33' => [['module' => 'paquetes-ems.almacen', 'action' => 'print']],
            ...
            'mandarseleccionadosregional' => [['module' => 'paquetes-ems.almacen', 'action' => 'assign']],
            'mandarseleccionadoscontratosregional' => [['module' => 'paquetes-ems.almacen', 'action' => 'assign']],
            'mandarseleccionadosventanillaems' => [['module' => 'paquetes-ems.almacen', 'action' => 'assign']],
    ...
    private static function actionLabel(string $permissionName, string $actionKey): string
    {
        $specialLabels = [
            ...
            'feature.paquetes-ems.almacen.create' => 'Boton: Nuevo / Registrar contrato',
            'feature.paquetes-ems.almacen.edit' => 'Boton: Editar / Anadir peso contrato',
            'feature.paquetes-ems.almacen.assign' => 'Boton: Enviar a ventanilla / Regional',
            'feature.paquetes-ems.almacen.print' => 'Boton: Reimprimir boleta / CN-33',
    ...
    private static function permissionHint(string $permissionName, string $moduleKey, string $actionKey): ?string
    {
        $specialHints = [
            ...
            'feature.paquetes-ems.almacen.create' => 'Controla Nuevo y Registrar contrato dentro de la ventana Almacen EMS.',
            'feature.paquetes-ems.almacen.edit' => 'Controla Editar y Anadir peso contrato dentro de la ventana Almacen EMS.',
            'feature.paquetes-ems.almacen.assign' => 'Controla Enviar a ventanilla EMS, Manda a regional y acciones de traspaso desde Almacen EMS.',
            'feature.paquetes-ems.almacen.print' => 'Controla Reimprimir boleta y Reimprimir CN-33 dentro de la ventana Almacen EMS.',
