...
class AclPermissionRegistry
{
    ...
    private const WINDOW_FEATURE_ALLOWLIST = [
        ...
        'despachos.todos' => [],
        'eventos-ems.index' => ['view', 'create', 'edit', 'delete'],
        'eventos-certi.index' => ['view', 'create', 'edit', 'delete'],
        'eventos-ordi.index' => ['view', 'create', 'edit', 'delete'],
        'eventos-despacho.index' => ['view', 'create', 'edit', 'delete'],
        'eventos-contrato.index' => ['view', 'create', 'edit', 'delete'],
    ...
    private const LIVEWIRE_METHOD_TARGET_OVERRIDES = [
        ...
        'EventosTabla' => [
            'searchregistros' => [['module' => 'eventos-ems.index', 'action' => 'view']],
    ...
    private static function actionLabel(string $permissionName, string $actionKey): string
    {
        $specialLabels = [
            ...
            'feature.eventos-ems.index.view' => 'Boton: Buscar registros EMS',
            ...
            'feature.eventos-contrato.index.view' => 'Boton: Buscar registros Contrato',
    ...
    private static function permissionHint(string $permissionName, string $moduleKey, string $actionKey): ?string
    {
        $specialHints = [
            ...
            'feature.eventos-ems.index.view' => 'Controla el boton Buscar dentro de la ventana Eventos EMS.',
            ...
            'feature.eventos-contrato.index.view' => 'Controla el boton Buscar dentro de la ventana Eventos Contrato.',
