...
<body>
    ...
    <table class="kpis">
        <tr>
            <td><div class="label">Registros</div><div class="value">{{ \App\Support\BolivianNumber::format($summary['total_registros']) }}</div></td>
            <td><div class="label">Orígenes</div><div class="value">{{ \App\Support\BolivianNumber::format($summary['origenes']) }}</div></td>
            <td><div class="label">Destinos</div><div class="value">{{ \App\Support\BolivianNumber::format($summary['destinos']) }}</div></td>
            <td><div class="label">Eventos</div><div class="value">{{ \App\Support\BolivianNumber::format($summary['eventos']) }}</div></td>
        </tr>
    </table>
    ...
    <table class="kpis">
        <tr>
            <td><div class="label">Transiciones</div><div class="value">{{ \App\Support\BolivianNumber::format($transitionSummary['total_transiciones'] ?? 0) }}</div></td>
            <td><div class="label">Promedio General</div><div class="value">{{ \App\Support\BolivianNumber::format((float) ($transitionSummary['promedio_general_dias'] ?? 0), 2) }}</div></td>
            <td><div class="label">Rutas</div><div class="value">{{ \App\Support\BolivianNumber::format($transitionSummary['rutas'] ?? 0) }}</div></td>
        </tr>
    </table>
        ...
        <tbody>
            @forelse($transitionRows as $transitionRow)
                <tr>
                    ...
                    <td class="right">{{ \App\Support\BolivianNumber::format((float) $transitionRow['promedio_dias'], 2) }}</td>
                    <td class="right">{{ \App\Support\BolivianNumber::format((float) $transitionRow['minimo_dias'], 2) }}</td>
                    <td class="right">{{ \App\Support\BolivianNumber::format((float) $transitionRow['maximo_dias'], 2) }}</td>
                </tr>
            @empty
                <tr>
