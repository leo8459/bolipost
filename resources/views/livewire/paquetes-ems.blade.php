                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input
                                            ...
                                            step="0.001"
                                            min="0"
                                            placeholder="Esperando balanza..."
                                            data-cas-peso-input
                                            readonly
                                            required
                                        >
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-outline-azul" wire:click="$set('peso', null)">Limpiar peso</button>
                                        </div>
                                    </div>
                                    @error('peso') <small class="text-danger">{{ $message }}</small> @enderror
                                    <div class="peso-cas-panel">
...
<script>
    (() => {
        if (window.__emsCasPesajeInit) {
            return;
        }
        window.__emsCasPesajeInit = true;
