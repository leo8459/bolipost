<div>
            ...
            <div class="header-app d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-center">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <input
                        ...
                        wire:model="search"
                    >
                    <button class="btn btn-outline-light2" type="button" wire:click="searchServicios">Buscar</button>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="muted small">
                        Total en pagina: <strong>{{ $servicios->count() }}</strong>
                    </div>
                </div>
                        ...
                        <tbody>
                            @forelse ($servicios as $servicio)
                                <tr>
                                    <td>
                                        <span class="pill-id">
                                            #{{ ($servicios->firstItem() ?? 0) + $loop->index }}
                                        </span>
                                    </td>
    ...
    <div class="modal fade" id="servicioModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
                ...
                <form wire:submit.prevent="save">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="nombre_servicio" class="form-control">
                            @error('nombre_servicio') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                    </div>
...
<script>
    window.addEventListener('openServicioModal', () => {
        $('#servicioModal').modal('show');
    });

    window.addEventListener('closeServicioModal', () => {
