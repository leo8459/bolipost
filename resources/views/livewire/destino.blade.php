<div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="muted small">
                        Total en pagina: <strong>{{ $destinos->count() }}</strong>
                    </div>
                </div>
                        ...
                        <tbody>
                            @forelse ($destinos as $destino)
                                <tr>
                                    ...
                                    <td>
                                        <button wire:click="openEditModal({{ $destino->id }})"
    ...
    <div class="modal fade" id="destinoModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
                ...
                <form wire:submit.prevent="save">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select wire:model.defer="nombre_destino" class="form-control">
                                <option value="">Seleccione...</option>
                                @foreach($departamentos as $dep)
                                    <option value="{{ $dep }}">{{ $dep }}</option>
                                @endforeach
                            </select>
                            @error('nombre_destino') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                    </div>
...
<script>
    window.addEventListener('openDestinoModal', () => {
        $('#destinoModal').modal('show');
    });

    window.addEventListener('closeDestinoModal', () => {
