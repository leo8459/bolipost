<div>
    ...
    <div class="plantilla-wrap">
        <div class="card card-app">
            <div class="header-app d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-center">
                <div>
                    <h4 class="fw-bold mb-0">Ventanillas</h4>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="muted small">
                        Total en pagina: <strong>{{ $ventanillas->count() }}</strong>
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            @forelse ($ventanillas as $ventanilla)
                                <tr>
                                    <td><span class="pill-id">{{ $ventanilla->nombre_ventanilla }}</span></td>
    ...
    <div class="modal fade" id="ventanillaModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog">
            <div class="modal-content">
                <form wire:submit.prevent="save">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{ $editingId ? 'Editar ventanilla' : 'Nueva ventanilla' }}
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="nombre_ventanilla" class="form-control uppercase-input">
                            @error('nombre_ventanilla') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                    </div>
...
<script>
    ...
    window.addEventListener('openVentanillaModal', () => {
        $('#ventanillaModal').modal('show');
    });

    window.addEventListener('closeVentanillaModal', () => {
        $('#ventanillaModal').modal('hide');
    });
</script>
