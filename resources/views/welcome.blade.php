        ...
        <div class="preregistro-panel">
            ...
            <form method="POST" action="{{ route('preregistros.public.store') }}" class="preregistro-form">
                ...
                <div class="preregistro-section-card">
                    ...
                    <div class="preregistro-grid">
                            ...
                            <select name="destino_id" required>
                                ...
                                @foreach ($preregistroDestinos as $destino)
                                    <option value="{{ $destino->id }}" @selected((int) old('destino_id') === (int) $destino->id)>
                                        {{ $destino->nombre_preregistro }}</option>
                                @endforeach
                            </select>
                            @error('destino_id')
                                <small>{{ $message }}</small>
                        ...
                        <div class="preregistro-field preregistro-field-full">
                            ...
                            <textarea name="contenido" rows="2" required>{{ old('contenido') }}</textarea>
                            @error('contenido')
                                <small>{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="preregistro-grid">
                        ...
                        <div class="preregistro-field">
                            ...
                            <input type="text" name="telefono_destinatario"
                                value="{{ old('telefono_destinatario') }}" inputmode="numeric" pattern="[0-9]*">
                        ...
                        <div class="preregistro-field">
                            ...
                            <input type="email" name="correo_electronico" value="{{ old('correo_electronico') }}"
                                autocomplete="email" placeholder="ejemplo@correo.com" required>
                ...
                <div class="preregistro-actions">
                    ...
                    <button class="btn btn-primary" type="submit">Generar c&oacute;digo de preregistro</button>
                </div>
            </form>
        </div>
    </div>
