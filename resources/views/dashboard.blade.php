            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-4">No hay datos por departamento para los filtros seleccionados.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
...
@section('js')
    ...
    <script>
        ...
        if (hasPickupAlert && canPlayPickupAlertSound && shouldPlayPickupSoundOnEntry) {
            ...
            // Reintento en cada entrada al dashboard para que suene siempre.
            let attempts = 0;
