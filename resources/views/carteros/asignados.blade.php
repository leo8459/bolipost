...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title mb-0">Paquetes en Estado ASIGNADO</h3>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover mb-0">
                    ...
                    <tbody id="tabla-asignados-body">
                        <tr>
                            <td colspan="10" class="text-center py-4">Cargando datos...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
@section('js')
    <script>
        (function() {
            ...
            function setLoading() {
                body.innerHTML = '<tr><td colspan="10" class="text-center py-4">Cargando datos...</td></tr>';
            }

            function setError() {
                body.innerHTML = '<tr><td colspan="10" class="text-center text-danger py-4">Error cargando datos.</td></tr>';
            }

            function renderRows(rows) {
                if (!rows.length) {
                    body.innerHTML = '<tr><td colspan="10" class="text-center py-4">No hay paquetes asignados.</td></tr>';
                    return;
                }
