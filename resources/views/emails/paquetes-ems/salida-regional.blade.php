...
<head>
    <meta charset="UTF-8">
    <title>Paquete EMS en camino</title>
</head>
<body style="margin:0;padding:24px;font-family:Verdana,DejaVu Sans,sans-serif;background:#eef2f7;color:#172033;">
    ...
    <div style="max-width:720px;margin:0 auto;background:#fff;border:1px solid #d8e1ec;border-radius:18px;overflow:hidden;box-shadow:0 18px 40px rgba(17,24,39,.08);">
        ...
        <div style="background:#20539a;color:#fff;padding:28px 32px;">
            <h1 style="margin:0;font-size:26px;line-height:1.25;">Tu paquete EMS est&aacute; en camino</h1>
            <p style="margin:10px 0 0;font-size:15px;line-height:1.6;opacity:.94;">
                El paquete parti&oacute; hacia el departamento de destino.
            </p>
        </div>
        ...
        <div style="padding:32px;">
            ...
            <p style="font-size:15px;line-height:1.7;">
                Te informamos que tu paquete con c&oacute;digo <strong>{{ $paquete->codigo }}</strong>
                parti&oacute; hacia <strong>{{ $destino }}</strong> y contin&uacute;a avanzando hacia su destino.
            </p>

            <div style="margin:24px 0;padding:22px;border:1px solid #d7e0eb;border-radius:16px;background:#f8fafc;text-align:center;">
                <div style="font-size:12px;text-transform:uppercase;letter-spacing:1px;color:#526075;">Departamento de destino</div>
                <div style="margin-top:10px;display:inline-block;padding:13px 20px;background:#f7c948;color:#172033;border-radius:10px;font-size:23px;font-weight:700;letter-spacing:1px;">{{ $destino }}</div>
            </div>

            <div style="padding:22px;border:1px solid #d7e0eb;border-radius:16px;background:#fff;">
                <p style="margin:0 0 14px;font-size:16px;font-weight:700;color:#173f75;">Detalle de la salida</p>
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:14px;">
                    <tr><td style="padding:7px 0;color:#526075;width:180px;">C&oacute;digo del paquete</td><td style="padding:7px 0;font-weight:600;">{{ $paquete->codigo }}</td></tr>
                    <tr><td style="padding:7px 0;color:#526075;">Origen</td><td style="padding:7px 0;font-weight:600;">{{ $paquete->origen ?: '-' }}</td></tr>
                    <tr><td style="padding:7px 0;color:#526075;">Destino regional</td><td style="padding:7px 0;font-weight:600;">{{ $destino }}</td></tr>
                    <tr><td style="padding:7px 0;color:#526075;">Fecha de salida</td><td style="padding:7px 0;font-weight:600;">{{ $fechaSalidaTexto }}</td></tr>
                    <tr><td style="padding:7px 0;color:#526075;">Modo de transporte</td><td style="padding:7px 0;font-weight:600;">{{ $transporte ?: 'No especificado' }}</td></tr>
                    <tr><td style="padding:7px 0;color:#526075;">Manifiesto CN-33</td><td style="padding:7px 0;font-weight:600;">{{ $manifiesto ?: '-' }}</td></tr>
                </table>
            </div>

            <p style="margin:22px 0 0;font-size:14px;line-height:1.7;">Te notificaremos conforme avance el proceso de entrega.</p>
