...
@section('title', 'Paquetes EMS - Devueltos')
@section('template_title')
    Paquetes EMS - Devueltos
@endsection
    ...
    <div class="ems-entregados-wrap">
        <div class="card ems-entregados-card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                <h3 class="card-title mb-2 mb-md-0">Devueltos</h3>
            ...
            <div class="card-body">
                ...
                @if (!$estadoDevolucionDisponible)
                    <div class="alert alert-warning">
                        No existe el estado DEVOLUCION en la tabla estados.
                    </div>
                @endif

                <form method="GET" action="{{ route('paquetes-ems.devueltos') }}" class="row mb-3">
                        ...
                        <tbody>
                            @forelse ($paquetes as $paquete)
                                <tr>
                                    ...
                                    <td>
                                        {{ !empty($paquete->fecha_devolucion) ? \Illuminate\Support\Carbon::parse($paquete->fecha_devolucion)->format('d/m/Y H:i') : '-' }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="11" class="text-center py-4">
                                        No hay registros en estado DEVOLUCION.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
