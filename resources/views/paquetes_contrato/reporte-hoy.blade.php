...
<head>
    <meta charset="utf-8">
    <title>Contratos generados hoy</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .guide-copy:last-child { margin-bottom: 0; }
        .guide-header { width: 100%; border-collapse: collapse; table-layout: fixed; background: #fff; border-bottom: 1px solid #000; }
        .guide-header td { border: 0; padding: 2px 7px; vertical-align: middle; }
        ...
        .content { padding: 4px 7px 3px; }
        .info-table { width: 100%; border-collapse: collapse; table-layout: fixed; }
        .info-table td { border: 1px solid #000; padding: 2px 5px; vertical-align: top; line-height: 1.08; white-space: normal; word-wrap: break-word; overflow-wrap: break-word; }
        .section-label { display: block; margin-bottom: 2px; color: #000; font-size: 8px; font-weight: 800; letter-spacing: .35px; text-transform: uppercase; }
        .value { font-size: 10px; font-weight: 700; color: #000; }
        .small-value { font-size: 9px; font-weight: 600; }
        .long-cell { height: 13mm; overflow: hidden; }
        .long-value { display: block; max-height: 9.5mm; overflow: hidden; font-size: 8.2px; font-weight: 700; line-height: 1.05; word-break: break-word; }
        .content-value { display: block; max-height: 11mm; overflow: hidden; font-size: 7.8px; font-weight: 700; line-height: 1.03; word-break: break-word; }
        .return-title { font-size: 9px; font-weight: 800; color: #000; text-transform: uppercase; }
        .return-grid { width: 100%; border-collapse: collapse; table-layout: fixed; margin-top: -1px; }
        .return-grid td { border: 1px solid #000; padding: 2px 4px; font-size: 8.2px; line-height: 1.1; }
        .box { display: inline-block; width: 9px; height: 9px; border: 1px solid #000; float: right; }
        .note { margin-top: 4px; padding: 3px 6px; border: 1px solid #000; background: #fff; font-size: 7.6px; line-height: 1.08; text-align: justify; }
        .signatures { width: 100%; border-collapse: collapse; table-layout: fixed; margin-top: 1px; }
        .signatures td { border: 0; padding: 1mm 10px 0; text-align: center; font-size: 8px; font-weight: 700; color: #000; height: 8mm; vertical-align: middle; }
    </style>
</head>
<body>
    @php
    ...
    @foreach($contratos as $contrato)
        @php
            ...
            $verificationUrl = ($verificationUrls ?? [])[$contrato->id] ?? null;
                ...
                <div class="guide-copy">
                    ...
                    <div class="content">
                        <table class="info-table">
                            <tr>
                                <td colspan="2" style="width: 50%;"><span class="section-label">Remitente</span><span class="value">{{ $contrato->nombre_r }}</span></td>
                                <td colspan="2" style="width: 50%;"><span class="section-label">Destinatario</span><span class="value">{{ $contrato->nombre_d }}</span></td>
                            </tr>
                            <tr>
                                <td><span class="section-label">Telefono remitente</span><span class="small-value">{{ $contrato->telefono_r }}</span></td>
                                <td><span class="section-label">Origen</span><span class="small-value">{{ $contrato->origen }}</span></td>
                                <td><span class="section-label">Telefono destinatario</span><span class="small-value">{{ $contrato->telefono_d ?: '-' }}</span></td>
                                <td><span class="section-label">Destino</span><span class="small-value">{{ $departamentoDetalle }}</span></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="long-cell"><span class="section-label">Direccion remitente</span><span class="long-value">{{ $contrato->direccion_r }}</span></td>
