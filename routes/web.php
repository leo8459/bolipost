...
Route::middleware(['auth', 'internal.only', 'route.permission'])->group(function () {
    Route::middleware('can:admin-only-menu')->group(function () {
        ...
        Route::post('/administrador/correo-electronico/cierre-diario/destinatarios', [ContractExpirationEmailController::class, 'addDailyClosingRecipient'])
            ->name('contract-expiration-email.daily-closing.recipients.store');
        Route::delete('/administrador/correo-electronico/cierre-diario/destinatarios', [ContractExpirationEmailController::class, 'removeDailyClosingRecipient'])
            ->name('contract-expiration-email.daily-closing.recipients.destroy');
    ...
    Route::post('/tracking-local-event-rules/sync', [TrackingLocalEventRuleController::class, 'sync'])->name('tracking-local-event-rules.sync');
    Route::get('/tracking-local-event-rules/{trackingLocalEventRule}/edit', [TrackingLocalEventRuleController::class, 'edit'])->name('tracking-local-event-rules.edit');
    Route::patch('/tracking-local-event-rules/{trackingLocalEventRule}/toggle-visibility', [TrackingLocalEventRuleController::class, 'toggleVisibility'])->name('tracking-local-event-rules.toggle-visibility');
    ...
    Route::get('/paquetes-ems/entregados/envio-no-registrado', [PaquetesEmsController::class, 'createEntregaNoRegistrada'])->name('paquetes-ems.entregados.no-registrado.create');
    Route::post('/paquetes-ems/entregados/envio-no-registrado', [PaquetesEmsController::class, 'storeEntregaNoRegistrada'])->name('paquetes-ems.entregados.no-registrado.store');
    ...
    Route::get('/tarifario-tiktoker/plantilla-excel', [TarifarioTiktokerController::class, 'downloadTemplateExcel'])->name('tarifario-tiktoker.template-excel');
    ...
    Route::post('/tarifario-tiktoker', [TarifarioTiktokerController::class, 'store'])->name('tarifario-tiktoker.store');
    Route::get('/tarifario-tiktoker/{tarifarioTiktoker}/edit', [TarifarioTiktokerController::class, 'edit'])->name('tarifario-tiktoker.edit');
